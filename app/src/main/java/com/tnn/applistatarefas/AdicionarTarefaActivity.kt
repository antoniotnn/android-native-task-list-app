...
import com.tnn.applistatarefas.databinding.ActivityAdicionarTarefaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            tarefa = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                bundle.getParcelable("tarefa", Tarefa::class.java)
            } else {
                bundle.getParcelable<Tarefa>("tarefa")
            }
